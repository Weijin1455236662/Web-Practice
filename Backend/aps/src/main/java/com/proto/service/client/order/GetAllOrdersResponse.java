...
/**
 * <p>getAllOrdersResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://Order.OrderService/}orderItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAllOrdersResponse {
    ...
    protected List<OrderItem> _return;
    ...
    public List<OrderItem> getReturn() {
        if (_return == null) {
            _return = new ArrayList<OrderItem>();
        }
        return this._return;
    }
